...
export default async function HomePage() {
  ...
  const schemaMarkup = {
    ...
    "@graph": [
      {
        "@type": "WebSite",
        "@id": "https://gomovies123.vercel.app/#website",
      ...
      {
        "@type": "WebPage",
        "@id": "https://gomovies123.vercel.app/#webpage",
        "url": "https://gomovies123.vercel.app/",
        "name": "GoMovies123 | Trending Movies & TV Shows to Stream Today",
        ...
        "isPartOf": { "@id": "https://gomovies123.vercel.app/#website" },
        ...
        "breadcrumb": { "@id": "https://gomovies123.vercel.app/#breadcrumb" }
      },
      {
        "@type": "BreadcrumbList",
        "@id": "https://gomovies123.vercel.app/#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
            "name": "Home",
            "item": "https://gomovies123.vercel.app/"
          }
        ]
      },
      {
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": "How often is trending content updated on GoMovies123?",
            "acceptedAnswer": {
              "@type": "Answer",
          ...
          {
            "@type": "Question",
            "name": "Can I find where to stream movies for free on GoMovies123?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Yes! GoMovies123 provides information on both free streaming options (ad-supported platforms) and premium subscription services, helping you find the most cost-effective way to watch your favorite content."
            }
          },
          {
            "@type": "Question",
            "name": "Does GoMovies123 cover international movies and TV shows?",
            "acceptedAnswer": {
              "@type": "Answer",
          ...
          {
            "@type": "Question",
            "name": "How does GoMovies123 determine what's trending?",
            "acceptedAnswer": {
              "@type": "Answer",
      ...
      <section className="relative bg-gradient-to-r from-purple-900/80 to-slate-900 py-16 lg:py-20" itemScope itemType="https://schema.org/WPHeader">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 text-white" itemProp="headline">
            GoMovies123 | Trending Movies & TV Shows to Stream Today
          </h1>
      ...
      <div className="container mx-auto px-4 py-8">
            ...
            <div className="bg-slate-900/50 p-6 rounded-lg mt-8">
              ...
              <div className="space-y-4">
                <div className="faq-item" itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                  <h4 className="font-semibold text-blue-300 mb-2" itemProp="name">How often is trending content updated on GoMovies123?</h4>
                ...
                <div className="faq-item" itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                  <h4 className="font-semibold text-blue-300 mb-2" itemProp="name">Can I find where to stream movies for free on GoMovies123?</h4>
                  <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                    <p className="text-gray-300" itemProp="text">
                      Yes! GoMovies123 provides information on both free streaming options (ad-supported platforms) and premium subscription services, helping you find the most cost-effective way to watch your favorite content.
                    </p>
                  </div>
                </div>
                
                <div className="faq-item" itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                  <h4 className="font-semibold text-blue-300 mb-2" itemProp="name">Does GoMovies123 cover international movies and TV shows?</h4>
                  <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                    <p className="text-gray-300" itemProp="text">
                ...
                <div className="faq-item" itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                  <h4 className="font-semibold text-blue-300 mb-2" itemProp="name">How does GoMovies123 determine what's trending?</h4>
                  <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                    <p className="text-gray-300" itemProp="text">
        ...
        <section className="text-center py-12 bg-gradient-to-r from-purple-900/30 to-blue-900/30 rounded-2xl border border-slate-700">
          ...
          <p className="mt-8 text-gray-400 max-w-3xl mx-auto text-xs md:text-sm">
            GoMovies123 • Trending Movies & TV Shows • Daily Updates • Streaming Availability • Netflix • Disney+ • Prime Video • Hulu • HBO Max • Free Streaming • HD Quality • What to Watch • Best Movies 2024 • Popular TV Series • Entertainment Guide • Movie Recommendations • Binge-Watch Series • New Releases • Top Rated Shows
          </p>
        </section>
      </div>
    </div>
...
export const metadata = {
  title: 'GoMovies123 | Trending Movies & TV Shows to Stream Today - Daily Updates',
  ...
  openGraph: {
    title: 'GoMovies123 | Trending Movies & TV Shows to Stream Today',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'GoMovies123 - Trending Movies & TV Series to Stream Today',
      },
    ],
    locale: 'en_US',
    type: 'website',
  ...
  twitter: {
    ...
    site: '@GoMovies123Movies',
    creator: '@GoMovies123Movies',
    title: 'GoMovies123 | Trending Movies & TV Shows to Stream Today',
    description: 'Discover what\'s trending today across all streaming platforms on GoMovies123.',
    images: ['https://live.staticflickr.com/65535/54796879356_0cf11547b4_b.jpg'],
  },
  alternates: {
    canonical: 'https://gomovies123.vercel.app/',
  },
};
